...
const props = defineProps({
    ...
    brands: Array,
    categories: Array,
    pagination: Object, // Pagination data passed from backend
})
                    ...
                    <section aria-labelledby="products-heading" class="pb-24 pt-6">
                        ...
                        <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                            ...
                            <div class="lg:col-span-3">
                                <!-- Your content -->
                                <div v-if="products.length === 0" class="flex flex-col items-center justify-center py-16 px-4 bg-white rounded-lg shadow-sm border border-gray-100">
                                    <div class="w-24 h-24 mb-6 rounded-full bg-red-50 flex items-center justify-center">
                                    ...
                                    <p class="text-gray-500 text-center max-w-md mb-6">We're working on adding new products to our collection. Stay tuned for exciting new arrivals coming soon!</p>
                                    <a href="/" class="px-6 py-3 bg-red-600 text-white rounded-lg font-medium hover:bg-red-700 transition-colors duration-300 shadow-md">
                                        Return to Homepage
                                    </a>
                                </div>
                                ...
                                <!-- Pagination -->
                                <div v-if="pagination && pagination.links" class="flex justify-center mt-8 space-x-2">
